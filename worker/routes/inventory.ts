...
const movementTypes = ["purchase", "customerReturn", "production", "inventoryInjection", "positiveAdjustment",
  "internalConsumption", "ownerWithdrawal", "waste", "posWaste", "negativeAdjustment", "transferToPos",
  "transferToWarehouse", "transformation", "disassembly", "disassemblyReturn"] as const;
