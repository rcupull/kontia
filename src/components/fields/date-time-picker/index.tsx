  ...
  return (
    <Popover.Root open={open} onOpenChange={setOpen}>
      <Popover.Trigger asChild>
        <div
          className={cn(
            "flex w-full min-w-0 cursor-pointer items-center justify-between gap-3 rounded-2xl border border-slate-200 px-4 py-3 text-left focus:outline-none focus:ring-4 focus:ring-emerald-600/10",
          )}
          role="button"
          tabIndex={0}
          onKeyDown={(event) => {
