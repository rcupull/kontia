...
ALTER TABLE investment_entries RENAME TO investment_entries_before_withdrawals;
...
SELECT
  ...
  pre_money_valuation_cents,affects_cash,financial_movement_id,entry_date,notes,
  created_by_user_id,created_at
FROM investment_entries_before_withdrawals;

DROP TABLE investment_entries_before_withdrawals;
